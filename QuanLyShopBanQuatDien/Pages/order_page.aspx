<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/master_page.Master" AutoEventWireup="true"
    CodeBehind="order_page.aspx.cs" Inherits="QuanLyShopBanQuatDien.Pages.order_page" %>
    ...
    <div id="body" class="bg-white">
        <div class="d-flex justify-content-between pl-4 py-3">
            <div class="flex-grow-1 row">
                <div class="col-5">
                    <div class="input-group rounded shadow">
                        <asp:TextBox ID="findTextBox" class="form-control" placeholder="Nhập mã hóa đơn..."
            ...
            <div class="d-flex justify-content-end mr-4">
                <asp:LinkButton ID="addButton" href="order_info.aspx" class="btn shadow btn btn-primary"
                    runat="server">
            ...
            <div class="table-responsive">
                <asp:GridView ID="gridView" class="bg-white rounded shadow table table-hover table-bordered text-center"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="code" HeaderText="Mã hóa đơn" />
                        <asp:BoundField DataField="orderDate" HeaderText="Ngày lập" DataFormatString="{0:dd/MM/yyyy}" />
