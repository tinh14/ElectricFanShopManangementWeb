<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/master_page.Master" AutoEventWireup="true" CodeBehind="customer_page.aspx.cs" Inherits="QuanLyShopBanQuatDien.Pages.customer_page" %>
    ...
    <div id="body" class="bg-light">
        <div class="d-flex justify-content-between pl-4 py-3">
            <div class="flex-grow-1 row">
                <div class="col-5">
                    <div class="input-group rounded shadow">
                        <asp:TextBox ID="findTextBox" class="form-control" placeholder="Tìm khách hàng..."
            ...
            <div class="d-flex justify-content-end mr-4">
                <asp:LinkButton ID="addButton" href="customer_info.aspx" class="btn shadow btn btn-primary"
                    runat="server">
